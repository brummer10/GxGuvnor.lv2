...
static void ref_value_changed(GtkAdjustment *adj, gpointer* args) {
	...
	gx_guvnorUI* ui = (gx_guvnorUI*)arg->ui;
    if (ui->block) {
        ui->block = 0;
        return;
    }
...
static LV2UI_Handle instantiate(const LV2UI_Descriptor*   descriptor,
    ...
    *widget = NULL;
    ...
    set_expose_func(GX_GUV_PAINT_BOX(ui->pbox),"pedal_expose");
    ...
    ui->label[2] = gtk_label_new("LEVEL");
    ...
    ui->label[4] = gtk_label_new("TREBLE");
    ...
    ui->args[4]->ui = ui;
    ui->args[4]->port_index = (int)TREBLE;
