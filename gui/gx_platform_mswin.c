...
void gx_gui_create_window_and_surface(gx_guvnorUI *ui) {
	...
	static TCHAR szClassName[] = TEXT("gx_guvnorUIClass");
	WNDCLASS wndclass = {0};
...
void gx_gui_destroy_main_window(gx_guvnorUI *ui) {
	...
	UnregisterClass(TEXT("gx_guvnorUIClass"), NULL);
}
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	gx_guvnorUI *ui = (gx_guvnorUI *)GetWindowLongPtr(hwnd, GWLP_USERDATA);
