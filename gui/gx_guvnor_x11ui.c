...
static LV2UI_Handle instantiate(const struct _LV2UI_Descriptor * descriptor,
	...
	ui->controls[0] = { 0.5, 0.5, 0.0, 1.0, 0.01, 50, 60, 61, 61, false,"LEVEL", KNOB, LEVEL};
	ui->controls[1] = { 0.5, 0.5, 0.0, 1.0, 0.01, 120, 30, 61, 61, false,"BASS", KNOB, BASS};
	ui->controls[2] = { 0.5, 0.5, 0.0, 1.0, 0.01, 190, 25, 61, 61, false,"MID", KNOB, MID};
	ui->controls[3] = { 0.5, 0.5, 0.0, 1.0, 0.01, 260, 30, 61, 61, false,"TREBLE", KNOB, TREBLE};
	ui->controls[4] = { 0.5, 0.5, 0.0, 1.0, 0.01, 330, 60, 61, 61, false,"GAIN", KNOB, GAIN};
